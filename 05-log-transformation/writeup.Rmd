...
log_unif<-log(runif(1000,min,max))
...
abline(lm(ari_rec~geo_rec),col="red")
...
abline(lm(ari_rec_1~geo_rec_1),col="red")
...
abline(lm(ari_rec_2~geo_rec_2),col="red")
