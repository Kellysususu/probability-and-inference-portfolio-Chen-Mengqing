...
p_win_0.55<-1-pbinom(3,7,0.55)
p_win_0.45<-1-pbinom(3,7,0.45)
...
From question 1, we know that **P(B|A)=P(winning the world series|p=0.55)=0.6082878**
```{r}
p_a<-0.5
p_b<-0.5
p_b_a<-0.6082878
p_final<-p_b_a*p_a/p_b
p_final
```
Answer: The probability for the problem is 0.6082878.
